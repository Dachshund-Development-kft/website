...
const Blobs: React.FC = () => {
    ...
    return (
        <div>
            ...
            <img src="./blobBottom.svg" alt="Blob" style={{ position: 'absolute', top: `${pageCenter+pageCenter-635}px`, left:-700, zIndex: -1, width: '1200px', filter: 'blur(600px)', opacity:0.25 }} /> 
        </div>
    );
};
